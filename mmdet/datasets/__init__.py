...
from .pipelines.replace_ImageToTensor import replace_ImageToTensor
...
__all__ = [
    ...
    'ConcatDataset', 'RepeatDataset', 'MultiImageMixDataset', 'ClassBalancedDataset',
    'WIDERFaceDataset', 'DATASETS', 'PIPELINES', 'build_dataset','replace_ImageToTensor'
]
