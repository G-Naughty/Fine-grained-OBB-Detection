...
data_root = '/home/hnu1/GGM/OBBDetection/data/FaIR1M/'
img_norm_cfg = dict(
...
log_level = 'INFO'
load_from = None
resume_from = None #'/home/ggm/GGM/OBBDetection-master/tools/work_dirs/faster_rcnn_orpn_r50_fpn_1x_dota10/epoch_10.pth'    #None
workflow = [('train', 1)]