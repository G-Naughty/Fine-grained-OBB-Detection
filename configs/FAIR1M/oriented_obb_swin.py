_base_ = [
    '/home/hnu1/GGM/OBBDetection/configs/obb/_base_/datasets/dota.py',
    '/home/hnu1/GGM/OBBDetection/configs/obb/_base_/schedules/schedule_1x.py',
    '/home/hnu1/GGM/OBBDetection/configs/_base_/default_runtime.py'
]
model = dict(
    type='OrientedRCNN',
    pretrained='/home/hnu1/GGM/OBBDetection/swin_pretrain/obb_swin_small_patch4_window7_224.pth',
    backbone=dict(
...
test_cfg = dict(
    rpn=dict(
        ...
        min_bbox_size=0),
    rcnn=dict(
        score_thr=0.001, nms=dict(type='obb_nms', iou_thr=0.1), max_per_img=2000))
...
data_root = '/home/hnu1/GGM/OBBDetection/data/FaIR1M/'#/home/disk/patch_dataset/C919/split_data
data = dict(
    samples_per_gpu=2,
    workers_per_gpu=4,
    train=dict(
